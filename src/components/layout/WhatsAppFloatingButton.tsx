...
export function WhatsAppFloatingButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 inline-flex h-14 w-14 items-center justify-center rounded-full bg-[var(--whatsapp)] text-white shadow-[0_16px_35px_rgba(37,211,102,0.35)] transition hover:-translate-y-0.5 hover:bg-[var(--whatsapp-dark)] focus-ring"
    >
      <svg
        aria-hidden="true"
        viewBox="0 0 32 32"
