...
export function Header() {
  ...
  useEffect(() => {
    function updateHeaderVisibility() {
      ...
      if (scrollDifference > 0 && currentScrollY > 180) {
  ...
  return (
    <>
      <header
        className={`fixed inset-x-0 top-0 z-50 border-b border-[#C9D6E4] bg-[#F4F8FC]/95 backdrop-blur-xl transition-all duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] lg:translate-y-0 ${
          hideMobileHeader ? "-translate-y-full" : "translate-y-0"
        } ${
          hasScrolled
            ? "shadow-[0_12px_30px_rgba(15,23,42,0.11)]"
